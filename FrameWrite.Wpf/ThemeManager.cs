...
namespace FrameWrite.Wpf
{
    ...
    public static class ThemeManager
    {
        ...
        public static readonly Theme[] Themes =
        {
            ...
            new() { Name = "Synth",    Bg = "#110C16", Surface = "#1A1322", SurfaceAlt = "#251A30", Stroke = "#33243F", TextPrimary = "#EEE6F5", TextSecondary = "#8E7DA0", Accent = "#C061F0", Accent2 = "#00FF7B", Success = "#48C9B0", Danger = "#F25C8A" },
            // Light is a MID grey theme (not blinding white) with contrast carried by BOLD BLACK rather than a
            // hue (Spike, 2026-07-13): accent + labels are near-black; the go-green Success is kept (semantic).
            new() { Name = "Light",    Bg = "#D3D5D3", Surface = "#E3E5E3", SurfaceAlt = "#C7CAC7", Stroke = "#AEB2AE", TextPrimary = "#1B1E1B", TextSecondary = "#565A56", Accent = "#111311", Accent2 = "#111311", Success = "#2E7D32", Danger = "#D1453B" },
        };

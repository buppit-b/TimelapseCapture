...
namespace FrameWrite.Wpf
{
    ...
    public static class ThemeManager
    {
        ...
        public static readonly Theme[] Themes =
        {
            ...
            new() { Name = "Synth",    Bg = "#110C16", Surface = "#1A1322", SurfaceAlt = "#251A30", Stroke = "#33243F", TextPrimary = "#EEE6F5", TextSecondary = "#8E7DA0", Accent = "#C061F0", Accent2 = "#48C9B0", Success = "#48C9B0", Danger = "#F25C8A" },
            new() { Name = "Light",    Bg = "#F4F5F4", Surface = "#FFFFFF", SurfaceAlt = "#EAEDEA", Stroke = "#D4D8D4", TextPrimary = "#1A1F1A", TextSecondary = "#5C6B5C", Accent = "#2E9E40", Accent2 = "#B5651D", Success = "#2E9E40", Danger = "#D1453B" },
        };
